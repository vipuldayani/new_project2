    ...
    if(empty($_SESSION['user_id']))
{
    ...
    {
        mysqli_query($con, "UPDATE tbl_featuress_icon SET icon1='" . $_POST['icon1'] . "', sub_title1='" . $_POST['sub_title1'] . "', last_title1='" . $_POST['last_title1'] . "' WHERE id = '" . $_POST['id'] . "'  ");
        header('Location:featuress.php');
    }
    
    $select_query = mysqli_query($con, "SELECT * FROM `tbl_featuress_icon` WHERE id = '" . $_GET['id'] . "' ");
                    ...
                    <div class="page-header float-right">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                <li class="active">Update Featuress</li>
                            </ol>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <strong class="card-title">Featuress</strong>
                                </div>
                                <div class="card-body">
                                    <!-- Credit Card -->
                                    <div id="pay-invoice">

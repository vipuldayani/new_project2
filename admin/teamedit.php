...
mysqli_query($con, "UPDATE tbl_team_image SET image = '" . $image . "',name='".$_POST['name']."' WHERE id = '".$_POST['image_id']."' ");
...
$select_query = mysqli_query($con, "SELECT * FROM `tbl_team_image` WHERE id = '" . $_GET['id'] . "' ");
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Our Team image</strong>
                        </div>
                        <div class="card-body">
                            <!-- Credit Card -->
                            <div id="pay-invoice">
                                <div class="card-body">
                                    ...
                                    <form method="post" action="" enctype="multipart/form-data">    
                                        ...
                                        <div class="form-group">
                                            <label for="cc-payment" class="control-label mb-1">Table About Image</label>
                                            <br /><br />
